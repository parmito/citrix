...
#define SAMPLE_DEVICE_NAME          "CITRIX"
...
static const uint8_t spp_adv_data[23] = {
    0x02,0x01,0x06,
    0x03,0x03,0xE0,0xFF,
    0x0F,0x09,0x43,0x49,0x54,0x52,0x49,0x58
};

static uint16_t spp_mtu_size = 64;
            ...
            if(p_data->write.is_prep == false){
               /* ESP_LOGI(GATTS_TABLE_TAG, "ESP_GATTS_WRITE_EVT : handle = %d\n", res);*/
                if(res == SPP_IDX_SPP_COMMAND_VAL){
					...
					if(strstr((const char*)spp_cmd_buff,"$CONF:") != NULL)
                	{
	                    ESP_LOGI(GATTS_TABLE_TAG, "$CONF:\r\n");
						/* Receive data over BT and pass it over to SD*/
						stBleMsg.ucSrc = SRC_BLE;
						stBleMsg.ucDest = SRC_SD;
						stBleMsg.ucEvent = EVENT_SD_READWRITE_CONFIG;
						stBleMsg.pcMessageData = (char*)spp_cmd_buff;

						xQueueSend( xQueueSd, ( void * )&stBleMsg, NULL);
                	}
...
#endif
    xTaskCreate(vTaskBle, "vTaskBle", 2048, NULL, configMAX_PRIORITIES-3, NULL);
}
